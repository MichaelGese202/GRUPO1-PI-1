...
<head>
    ...
    <title>Lista de Exigencias - SoilScope</title>
    <style>
        body {
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td>18/08/25</td>
                <td>E</td>
                <td>Materia: El sistema monitorea variables del suelo agrícola (humedad, nutrientes (NPK) y temperatura). Los sensores tendrán una precisión de ±3% para humedad, ±2% en nutrientes NPK y ±0.5 °C en temperatura, garantizando mediciones fiables para un manejo eficiente (4) (5). La salida será un registro digital de datos accesible vía aplicación móvil o plataforma web, con funciones de alerta и trazabilidad agronómica para decisiones de riesgo y fertilización.</td>
                <td>MG.A</td>
            </tr>
            <tr>
                <td>18/08/25</td>
