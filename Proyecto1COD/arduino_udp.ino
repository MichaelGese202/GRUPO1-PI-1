...
const char* udpServerIP = "10.81.162.141";
...
void loop() {
  ...
  // Convertir a porcentaje (0% = seco, 100% = muy húmedo)
  ...
  Serial.println("✅ Enviado via UDP\n");
